  ...
  return (
    <div className="view">
      <header className="view-header">
        <h1 className="view-title">🇩🇪 German Tutor</h1>
        <p className="view-description">
          Have a natural, spoken conversation with your German language coach.
        </p>
      </header>

      <div className="gvc-card">
        <div className="gvc-stage">
          <div className="gvc-audio-orb" data-state={state}>
