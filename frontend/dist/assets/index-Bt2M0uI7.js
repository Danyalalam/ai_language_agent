...
* See the LICENSE file in the root directory of this source tree.
*/
var toCamelCase$1 = (string) => string.replace(/^([A-Z])|[\s-_]+(\w)/g, (match, p1, p2) => p2 ? p2.toUpperCase() : p1.toLowerCase());
//#endregion
...
var NAV_ITEMS = [{
	...
	icon: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(MessageCircle, { size: 20 })
}, {
	id: "pronunciation",
	label: "Pronunciation",
	hint: "Score your speech",
	icon: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(MicVocal, { size: 20 })
}];
var Sidebar = ({ view, onViewChange }) => {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Languages, { size: 22 })
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "sidebar-brand-text",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						className: "sidebar-title",
						children: "Sprachcoach"
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						className: "sidebar-subtitle",
						children: "AI Language Agent"
					})]
				})]
			}),
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					...
					children: "Powered by Azure VoiceLive"
				})
			})
		]
	});
...
//#endregion
//#region src/services/voiceLiveClient.ts
/**
...
function buildWebSocketUrl() {
	...
	if (/^https?:\/\//i.test(base)) return `${base.replace(/^http/, "ws")}/voice/live`;
	return `${window.location.protocol === "https:" ? "wss" : "ws"}://${window.location.host}${base}/voice/live`;
}
var VoiceLiveClient = class {
	ws = null;
	handlers;
	captureCtx = null;
	mediaStream = null;
	...
	openSocket() {
		return new Promise((resolve, reject) => {
			...
			ws.onerror = () => {
				...
				this.setState("error");
				reject(/* @__PURE__ */ new Error("WebSocket connection error"));
			};
			ws.onclose = () => {
				if (this.ws) this.setState("idle");
			};
	...
	flushPlayback() {
		for (const source of this.scheduledSources) try {
			source.stop();
		} catch {}
...
//#endregion
//#region src/components/GermanVoiceChat.tsx
var STATE_LABELS = {
...
var GermanVoiceChat = () => {
	...
	const handleStart = async () => {
		...
		const client = new VoiceLiveClient({
			...
			onTranscript: (role, text) => setTranscript((prev) => [...prev, {
				role,
				text
			}]),
		...
		try {
			...
			setError(err instanceof Error ? err.message : "Konnte die Sitzung nicht starten");
			setState("error");
			await client.stop();
			clientRef.current = null;
		}
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
				...
				children: "🇩🇪 German Tutor"
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				className: "view-description",
				children: "Have a natural, spoken conversation with your German language coach."
			})]
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "gvc-card",
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						className: `gvc-status gvc-status--${state}`,
						children: STATE_LABELS[state]
					})]
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "gvc-controls",
					children: !isActive ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
						className: "gvc-btn gvc-btn--start",
						onClick: handleStart,
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Mic, { size: 20 }), "Gespräch starten"]
					}) : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
						className: "gvc-btn gvc-btn--stop",
						onClick: handleStop,
						disabled: isConnecting,
						children: [isConnecting ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(LoaderCircle, {
							size: 20,
							className: "gvc-spin"
						}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PhoneOff, { size: 20 }), "Gespräch beenden"]
					})
				}),
				...
				transcript.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "gvc-transcript",
					children: transcript.map((line, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: `gvc-line gvc-line--${line.role}`,
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							className: "gvc-role",
							children: line.role === "assistant" ? "Coach" : "Du"
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							className: "gvc-text",
							children: line.text
						})]
...
var api = {
	...
	assessFromText: async (mode, language, text) => {
		try {
			const data = (await apiClient.post("/assess/text", {
				mode,
				language,
				text
			})).data;
			...
			return {
				...
				errors: (azure.word_details || []).filter((w) => w.error_type && w.error_type !== "None").map((w) => ({
	...
	assessFromAudio: async (mode, language, audioFile, text, proficiencyLevel, enableProsody, enableMiscue) => {
		try {
			...
			if (enableProsody !== void 0) formData.append("enable_prosody", String(enableProsody));
			if (enableMiscue !== void 0) formData.append("enable_miscue", String(enableMiscue));
			const data = (await apiClient.post("/assess/audio", formData, { headers: { "Content-Type": "multipart/form-data" } })).data;
			const azure = data.azure_result;
			return {
				pronunciation_score: azure.overall_score || 0,
				accuracy_score: azure.accuracy_score || 0,
	...
	getVoices: async (language) => {
		try {
			return (await apiClient.get(`/voices/${language}`)).data.voices || [];
		} catch (error) {
...
var ConfigPanel = ({ mode, language, proficiencyLevel, enableProsody, enableMiscue, onModeChange, onLanguageChange, onProficiencyChange, onProsodyToggle, onMiscueToggle }) => {
	const [availableModes, setAvailableModes] = (0, import_react.useState)([]);
	const [availableLanguages, setAvailableLanguages] = (0, import_react.useState)([]);
	const [showLanguageMenu, setShowLanguageMenu] = (0, import_react.useState)(false);
	const [showAdvanced, setShowAdvanced] = (0, import_react.useState)(false);
	(0, import_react.useEffect)(() => {
		const fetchConfig = async () => {
			try {
				const config = await api.getConfig();
				setAvailableModes(config.modes);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
				...
				children: "Speech Playground"
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "config-section",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", {
					className: "section-label",
					children: "Pronunciation mode"
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "radio-group",
					children: availableModes.map((m) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", {
					...
					className: "section-label",
					children: "Language to assess"
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "dropdown-wrapper",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
						className: "dropdown-button",
						onClick: () => setShowLanguageMenu(!showLanguageMenu),
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: language }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChevronDown, { size: 20 })]
					}), showLanguageMenu && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "dropdown-menu",
						children: availableLanguages.map((lang) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
					...
					children: [showAdvanced ? "Hide advanced options" : "Show advanced options", /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChevronDown, {
						size: 16,
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: "advanced-field checkbox-field",
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", {
								...
								}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Enable Prosody Assessment" })]
							})
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: "advanced-field checkbox-field",
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", {
								...
								}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Enable Miscue Detection (Insertion/Omission)" })]
							})
						})
					]
				})]
...
var TextInput = ({ value, onChange, mode, placeholder = "Enter or paste text here...", readOnly = false }) => {
	...
	if (mode === "gaming") return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		className: "text-input-container gaming-mode",
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "twister-display-box",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "twister-content",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Volume2, {
					className: "speaker-icon",
					size: 24
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					className: "twister-text",
					children: value
				})]
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "twister-footer",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "twister-instruction",
					children: "Get ready and start recording as you read the tongue twister aloud."
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "twister-actions",
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
						className: "generate-btn",
						onClick: generateNewTwister,
						children: "Generate new twister"
					})
				})]
			})]
		})
...
//#endregion
//#region src/components/AudioRecorder.tsx
var AudioRecorder = ({ onRecordingComplete, isLoading = false }) => {
	...
	const [time, setTime] = (0, import_react.useState)("00:00");
	...
	const startRecording = async () => {
		try {
			...
			mediaRecorder.onstop = () => {
				...
				onRecordingComplete(new Blob(chunksRef.current, { type: mimeType }));
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			children: !isRecording ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
				className: "btn-record",
				onClick: startRecording,
				disabled: isLoading,
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Mic, { size: 20 }), "Record"]
			}) : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
				className: "btn-stop",
				onClick: stopRecording,
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Square, { size: 20 }), "Stop"]
			})
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
			className: "timer",
			children: time
...
//#endregion
//#region src/components/AudioUploader.tsx
var AudioUploader = ({ onFileSelected, onRecordingFromMicrophone: _onRecordingFromMicrophone, isLoading = false }) => {
	...
	const handleDrop = (e) => {
		...
		if (files.length > 0) {
			...
			if (audioFile.type.startsWith("audio/") || audioFile.name.endsWith(".wav") || audioFile.name.endsWith(".mp3") || audioFile.name.endsWith(".webm") || audioFile.name.endsWith(".m4a")) onFileSelected(audioFile);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "audio-uploader-section",
		children: [
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", { children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
							className: "link-button",
							onClick: () => fileInputRef.current?.click(),
							children: "record audio with a microphone"
						})
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
					...
					disabled: isLoading,
					onClick: () => fileInputRef.current?.click(),
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Upload, { size: 16 }), "Browse Files"]
				})
			})
		]
	});
...
//#endregion
//#region src/components/AssessmentResult.tsx
var PronunciationResultComponent = ({ result, loading = false }) => {
	...
	if (loading) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			className: "loading",
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "Assessing pronunciation..." })
		})
	});
	if (!result) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "Upload or record audio to see assessment results" })
		})
	});
	...
	const renderHighlightedText = () => {
		if (!result.word_details || result.word_details.length === 0) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
			className: "assessment-text",
			children: result.assessment_text
		});
		return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
			className: "assessment-text highlighted",
			children: result.word_details.map((w, i) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
									...
									children: [
										...
										" / ",
										formatTime(duration || (result.duration ? result.duration / 1e3 : 0))
									]
								})
							]
						})]
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "assessment-text-section",
						children: renderHighlightedText()
					}),
					result.ai_report && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								...
								children: result.ai_report.summary
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "ai-details",
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										className: "ai-detail-item",
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h4", { children: "Strengths" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", { children: result.ai_report.strengths.map((s, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: s }, i)) })]
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										className: "ai-detail-item",
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h4", { children: "Weaknesses" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", { children: result.ai_report.weaknesses.map((w, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: w }, i)) })]
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										className: "ai-detail-item",
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h4", { children: "Recommendations" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", { children: result.ai_report.recommendations.map((r, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: r }, i)) })]
									})
								]
							})
						]
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CircleAlert, { size: 14 }), " Mispronunciations"]
								})]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", {
								className: "toggle-item",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
									...
									className: "toggle-label",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(X, { size: 14 }), " Omissions"]
								})]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", {
								className: "toggle-item",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
									...
									className: "toggle-label",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CircleAlert, { size: 14 }), " Insertions"]
								})]
							})
						]
					})]
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
						...
						children: "Pronunciation score"
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "score-display",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: "score-circle",
							style: { borderTopColor: getScoreColor(score) },
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		...
		}), result.errors && result.errors.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "errors-list-section",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h4", {
				className: "errors-list-title",
				children: "Detected errors:"
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "errors-list",
				children: result.errors.map((error, index) => renderError(error, index))
			})]
		})]
	});
};
//#endregion
//#region src/components/PronunciationView.tsx
function PronunciationView() {
	const [mode, setMode] = (0, import_react.useState)("reading");
	const [language, setLanguage] = (0, import_react.useState)("English (US)");
	const [proficiencyLevel, setProficiencyLevel] = (0, import_react.useState)("Intermediate");
	const [enableProsody, setEnableProsody] = (0, import_react.useState)(true);
	const [enableMiscue, setEnableMiscue] = (0, import_react.useState)(true);
	const [sampleText, setSampleText] = (0, import_react.useState)("Hello, how are you?");
	const [assessmentResult, setAssessmentResult] = (0, import_react.useState)(null);
	const [isLoading, setIsLoading] = (0, import_react.useState)(false);
	const [error, setError] = (0, import_react.useState)(null);
	(0, import_react.useEffect)(() => {
		return () => {
			if (assessmentResult?.audio_url) URL.revokeObjectURL(assessmentResult.audio_url);
		};
	}, [assessmentResult?.audio_url]);
	(0, import_react.useEffect)(() => {
		if (mode === "gaming") setSampleText("Autumn leaves lazily linger.");
		else if (mode === "reading") setSampleText("Hello, how are you?");
	}, [mode]);
	...
	const handleRecordingComplete = (audioBlob) => {
		...
		assessPronunciation(new File([audioBlob], `recording.${extension}`, { type: mime }));
	};
	const assessPronunciation = async (audioFile) => {
		setIsLoading(true);
		setError(null);
		const audioUrl = URL.createObjectURL(audioFile);
		try {
			setAssessmentResult({
				...await api.assessFromAudio(mode, language, audioFile, sampleText, proficiencyLevel, enableProsody, enableMiscue),
				audio_url: audioUrl
			});
		} catch (err) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
				...
				className: "view-description",
				children: "Read a script aloud and get scored on accuracy, fluency, and prosody."
			})]
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "pronunciation-layout",
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(AudioUploader, {
								onFileSelected: handleFileSelected,
								onRecordingFromMicrophone: handleRecordingComplete,
								isLoading
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(AudioRecorder, {
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(PronunciationResultComponent, {
...
//#region src/App.tsx
function App() {
	const [view, setView] = (0, import_react.useState)("tutor");
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "app",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Sidebar, {
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: view === "tutor" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(GermanVoiceChat, {}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PronunciationView, {})
			})
		})]
	});
}
